...
// إعدادات الاستثمارات
const INVESTMENTS = {
  1: { name: 'قصير', min: 100, rate: 0.10, durationMs: 24 * 3600 * 1000 },
  2: { name: 'متوسط', min: 200, rate: 0.20, durationMs: 48 * 3600 * 1000 },
  3: { name: 'طويل', min: 300, rate: 0.30, durationMs: 4 * 24 * 3600 * 1000 }
};
